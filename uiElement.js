...
(function (root, factory) {
    if (typeof define === "function" && define.amd) {
        ...
        define(["uielement"], function (uielement) {
            return (root.myModule = factory(uielement));
        });
    } else if (typeof module === "object" && module.exports) {

        module.exports = (root.uielement = factory(require("uielement")));
    } else {
        root.uielement = factory(root.uielement);
    }
}(this, function (uielement) {
